...
// ---------------------------------------------------
// ---------------------------------------------------
// - Componente para gestionar el alta de un anuncio -
// ---------------------------------------------------
// ---------------------------------------------------
const AnuncioAlta = () => {
  ...
  // Estado para que no se pueda pulsar el boton anunciar si aún está registrando el anuncio
  ...
  const handleNext = () => {
    ...
    if (activeStep === 2) gestionarAnuncioAlta();
  ...
  // ---------------------------------------------
  // - Método que gestiona el alta de un anuncio -
  // ---------------------------------------------
  const gestionarAnuncioAlta = async () => {
    setLoading(true);
    vaciarYSanear();
    ...
    try {
      ...
      dispatch(
        setDispatchMensajeAMostrar({
          tipo: "success",
          texto: "Anuncio creado correctamente",
        })
      );
      navegar("/misAnuncios");
    } catch (error) {
  ...
  return (
    <Contenedor>
      ...
      <MenuSuperior>
        ...
        <TituloMenuSuperior>Poner anuncio</TituloMenuSuperior>
      </MenuSuperior>
      <BoxPersonal>
        <ContenedorStepper>
